...
Open a terminal in the project root (`/Users/amansawarn/Documents/self_projects/TravelAgent`) and run:
...
```bash
cd /Users/amansawarn/Documents/self_projects/TravelAgent/frontend
npm install
npm run dev
```
