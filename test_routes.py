...
from services.flight_search import Search, CheapestFlightSearchDetails
...
async def test_routes():
    ...
    for origin, dest in routes:
        ...
        try:
            ...
            # Note: The current implementation in flight_search.py might catch the 500 and return an error dict.
